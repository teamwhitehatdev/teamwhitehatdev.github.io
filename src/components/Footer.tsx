...
import { Shield, Terminal, Globe, Server, ExternalLink, Smartphone, Lock, Heart, CheckCircle, MapPin } from 'lucide-react';
    ...
    <footer className="bg-black/95 border-t border-cyan-500/30 text-gray-400 font-mono text-xs mt-16 select-none relative z-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 pb-8 border-b border-gray-900">
          ...
          {/* SECTION 2: WEBSITES MAPPING / SITEMAP */}
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-xs font-sans">
              ...
              <li>
                <Link to="/admin" className="hover:text-purple-400 text-purple-300 font-bold transition-colors flex items-center space-x-1.5">
                  <span className="text-purple-400">&rsaquo;</span>
                  <span>🔑 MASTER BACK-END CMS PORTAL</span>
                </Link>
              </li>
            </ul>
          </div>
